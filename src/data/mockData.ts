import { Project, Product, Service, Article, CustomerContact } from '../types';
...
export const INITIAL_CUSTOMERS: CustomerContact[] = [
  {
    ...
    fullName: 'مهندس سعید میرزایی',
    phoneNumber: '09112255880',
    email: 'mirzaei.farm@gmail.com',
    companyName: 'مزرعه پرورشی طبرستان',
    role: 'مدیر تولید و فارم',
    source: 'quote',
    notes: 'متقاضی خط کامل دانخوری بشقابی پروانه‌ای با موتور گیربکس اروپایی برای ۲ سالن ۳۰ هزارتایی.',
    createdAt: '2025-01-15T08:30:00.000Z',
    pipelineStage: 'proposal',
    dealValue: '۸۵۰ میلیون تومان',
    farmCapacity: '۶۰ هزار قطعه',
    province: 'مازندران',
    tags: ['دانخوری پروانه‌ای', 'موتور گیربکس', 'سالن گوشتی'],
    nextFollowUpDate: getDynamicDate(0), // امروز
    nextFollowUpTime: '11:30',
    nextFollowUpNote: 'تماس جهت هماهنگی ارسال پیش‌فاکتور رسمی خطوط دانخوری و تاییدیه مالی اولیه',
    ...
    followUpHistory: [
      {
        ...
        note: 'تماس اولیه گرفته شد؛ مشخصات فنی سالن‌ها دریافت و برای واحد مهندسی ارسال گردید.',
        performedBy: 'واحد مهندسی فروش',
        status: 'completed',
        priority: 'high'
      }
    ]
  },
  {
    ...
    fullName: 'دکتر علیرضا کاظمی',
    phoneNumber: '09153184490',
    email: 'kazemi@shargh-feed.ir',
    companyName: 'کارخانه خوراک شرق نوین',
    role: 'مدیرعامل',
    source: 'quote',
    notes: 'طرح توسعه کارخانه خوراک دام و طیور، کاندیشنر دوجداره استیل و پرس پلت ۵۰۸ صنعتی.',
    createdAt: '2025-01-10T14:15:00.000Z',
    pipelineStage: 'negotiation',
    dealValue: '۲.۴ میلیارد تومان',
    farmCapacity: 'کارخانه خوراک دام',
    province: 'خراسان رضوی',
    tags: ['پرس پلت صنعتی', 'کاندیشنر استیل', 'خوراک دام'],
    nextFollowUpDate: getDynamicDate(-2), // ۲ روز معوقه
    nextFollowUpTime: '15:00',
    nextFollowUpNote: 'پیگیری بازخورد هیئت مدیره در خصوص پروپوزال فنی و پیش‌پرداخت ارزی ماشین‌آلات',
    followUpPriority: 'high',
    followUpStatus: 'pending',
    followUpHistory: [
      {
        ...
        note: 'کاتالوگ و پروپوزال از طریق پیام‌رسان ارسال شد.',
        performedBy: 'مدیر بازرگانی',
        status: 'completed',
        priority: 'medium'
      }
    ]
  },
  {
    ...
    fullName: 'حاج بهروز ناصری',
    phoneNumber: '09123456789',
    email: 'naseri.poultry@yahoo.com',
    companyName: 'مجتمع قفس تخم‌گذار البرز',
    role: 'مالک و سرمایه‌گذار',
    source: 'consultation',
    notes: 'احداث ۲ سوله جدید ۶۰ هزارتایی قفس اتوماتیک باتری با سیستم جمع‌آوری کود و تخم‌مرغ.',
    createdAt: '2025-01-20T09:45:00.000Z',
    pipelineStage: 'consulting',
    dealValue: '۱.۸ میلیارد تومان',
    farmCapacity: '۱۲۰ هزار قطعه',
    province: 'البرز',
    tags: ['قفس باتری اتوماتیک', 'جمع‌آوری تخم‌مرغ', 'طراحی سوله'],
    nextFollowUpDate: getDynamicDate(3), // ۳ روز دیگر
    nextFollowUpTime: '10:00',
    nextFollowUpNote: 'جلسه حضوری در دفتر گرگان جهت بررسی نقشه فونداسیون و ابعاد سوله‌ها',
  ...
  {
    id: 'cust-104',
    fullName: 'مهندس محمدرضا حسینی',
    phoneNumber: '09358899120',
    email: 'hoseini.farm4@gmail.com',
    companyName: 'مرغداری گوشتی سبز گرگان',
    role: 'مسئول فنی',
    source: 'consultation',
    notes: 'رفع عیب تهویه تونلی و تنظیم اتوماسیون پد سلولزی و پنجره‌های اینلت سالن شماره ۳.',
    createdAt: '2025-01-05T16:20:00.000Z',
    pipelineStage: 'won',
    dealValue: '۳۲۰ میلیون تومان',
    farmCapacity: '۳۵ هزار قطعه',
    province: 'گلستان',
    tags: ['تهویه تونلی', 'اینلت', 'پد سلولزی'],
    lastFollowUpDate: '2025-01-18T14:00:00.000Z',
    nextFollowUpDate: getDynamicDate(7), // هفته آینده
    nextFollowUpTime: '12:00',
    nextFollowUpNote: 'بررسی نتایج تست دود و تنظیم زاویه بازشوی اینلت‌ها بعد از نصب سنسور فشار منفی',
    ...
    followUpHistory: [
      {
        ...
        note: 'کارشناس اعزام شد و تنظیم اولیه اینلت‌ها و سنسورها با موفقیت انجام شد.',
        performedBy: 'مهندس ناظر خدمات پس از فروش',
        status: 'completed',
        priority: 'medium'
      }
    ]
  ...
  {
    id: 'cust-105',
    fullName: 'مهندس کامران سلطانی',
    phoneNumber: '09141122334',
    email: 'soltani.aras@gmail.com',
    companyName: 'مجتمع طیور ارس مراغه',
    role: 'مدیر بازرگانی',
    source: 'quote',
    notes: 'درخواست خرید ۴ دستگاه جت هیتر ۱۰۰ کیلووات دوگانه‌سوز و سیستم اینلت با موتور وینچ اختصاصی.',
    createdAt: '2025-02-01T10:00:00.000Z',
    pipelineStage: 'new_lead',
    dealValue: '۴۹۰ میلیون تومان',
    farmCapacity: '۴۵ هزار قطعه',
    province: 'آذربایجان شرقی',
    tags: ['جت هیتر ۱۰۰', 'گرمایشی', 'اینلت'],
    nextFollowUpDate: getDynamicDate(1), // فردا
    nextFollowUpTime: '09:30',
    nextFollowUpNote: 'تماس اولیه جهت اعتبارسنجی ولتاژ برق فارم و نوع گاز مصرفی برای جت هیترها',
    followUpPriority: 'high',
    followUpStatus: 'pending',
    followUpHistory: []
  },
  {
    id: 'cust-106',
    fullName: 'حاج قاسم رضایی',
    phoneNumber: '09139988776',
    email: 'rezaei.yazd@chapar.ir',
    companyName: 'مرغداری کویر رضوان',
    role: 'مالک فارم',
    source: 'consultation',
    notes: 'نیاز به نوسازی کامل سیستم آبخوری نیپل ضدچکه استیل و تصفیه آب سالن‌ها به علت سختی آب کویر.',
    createdAt: '2025-02-04T12:30:00.000Z',
    pipelineStage: 'contacted',
    dealValue: '۲۸۰ میلیون تومان',
    farmCapacity: '۲۵ هزار قطعه',
    province: 'یزد',
    tags: ['آبخوری نیپل استیل', 'تصفیه آب', 'نوسازی'],
    nextFollowUpDate: getDynamicDate(2),
    nextFollowUpTime: '16:00',
    nextFollowUpNote: 'ارسال نمونه کاتالوگ نیپل استیل کارنو و بررسی سختی آب نمونه ارسالی',
    followUpPriority: 'medium',
    followUpStatus: 'pending',
    followUpHistory: [
      {
        ...
        note: 'تماس اولیه گرفته شد؛ نمونه آب جهت بررسی به آزمایشگاه ارسال می‌شود.',
        performedBy: 'کارشناس فنی',
        status: 'completed',
        priority: 'medium'
      }
    ]
